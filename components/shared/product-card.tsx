...
export const ProductCard: React.FC<Props> = ({
  ...
  const array = [
    "Эконом — дешево, быстро, удобно",
    "Стандарт — комфорт по разумной цене",
    "Комфорт — удобство и высокий уровень сервиса",
    "Комфорт+ — повышенный комфорт и сервис премиум-класса",
    "Бизнес класс — статус, комфорт и премиальный сервис",
    "Минивэн — простор и удобство для групп и больших семей",
    "Премиум класс — роскошь, стиль и безупречный сервис",
  ];
